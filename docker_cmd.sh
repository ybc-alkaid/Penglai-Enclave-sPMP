...
if [ $# == 0 ]; then
	...
	docker run -v $(pwd):/home/penglai/penglai-enclave -w /home/penglai/penglai-enclave --rm -it ddnirvana/penglai-enclave:v0.5 bash scripts/build_opensbi.sh
	exit 0
fi
...
if [[ $1 == *"clean"* ]]; then
	...
	docker run -v $(pwd):/home/penglai/penglai-enclave -w /home/penglai/penglai-enclave --rm -it ddnirvana/penglai-enclave:v0.5 rm -rf opensbi-0.9/build-oe
	exit 0
fi
